...
import com.example.springessentials.wrapper.PageableResponse;
...
public class AnimeControllerIT {
    ...
    private static final DevUser USER = DevUser.builder()
            .nome("Desenvolvedor")
            .password("{bcrypt}$2a$10$o6vNMdyxRwjwV1xniUkhdujlYAYXfKohR8oy8MrMs2afIRGtC6V3C")
            .username("dev")
            .authorities("ROLE_USER")
            .build();

    private static final DevUser ADMIN = DevUser.builder()
            .nome("Elivelton Gustavo")
            .password("{bcrypt}$2a$10$o6vNMdyxRwjwV1xniUkhdujlYAYXfKohR8oy8MrMs2afIRGtC6V3C")
            .username("elivelton")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("dev", "academy");
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("elivelton", "academy");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound() {
        ...
        List<Anime> animes = testRestTemplateRoleUser.exchange("/animes/find?nome=dbz", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>() {
                }).getBody();
